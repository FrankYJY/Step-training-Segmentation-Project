...
# name of training
parser.add_argument('--net_name', type=str, default='official Unet 2ndGAN hardtanh lightness',
                    help='the name of training this time, part of the subdirectory of save and image')

# choose generator and discriminator
generator = UNet(drop=0.3, in_channels=2)
...
img_dealing_method = "rotate crop flip"
