...
dir_input = 'dataset/DRIVE/test/1st_manual/'
dir_output = 'dataset/DRIVE/test/1st_manual_tv_resized/'
os.makedirs(dir_output, exist_ok=True)

def resize(dir_input,dir_output):
    count = 1

    trans = transforms.Resize((512, 512), Image.BICUBIC)
    ...
    for i in range(1, 21):
        ...
        img.save(dir_output + prefix + "_manual1.gif" )
        # print(img2.shape)
