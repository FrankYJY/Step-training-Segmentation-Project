...
# name of training
parser.add_argument('--net_name', type=str, default='official cycleGAN 2nd step 40 Prelus hue0.2 img-right lightness rotate crop flip seg-rotate crop flip',
...
img_dealing_method = "lightness rotate crop flip"
...
if opt.start_epoch != 0:
    ...
    Dlosses_forward = list(np.load(os.path.join(save_dir + 'Dlosses_forward_all.npy.npy')))
